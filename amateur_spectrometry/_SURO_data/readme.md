...
# Table of contents
  ...
  - [18_spectra_ER_X_source_I-131](#18_spectra_ER_X_source_I-131)
...
<img src="Images/Graph08_Cs137.png" alt="EG 3X source Cs-137 spectrum" width="800"/>
...
# 18_spectra_ER_X_source_I-131

- background spectrum "Background - office 1 hour" - measured in SÚRO office, 2nd floor
- I-131 radionuclide source (instrument check source) from Czech metrology institute (Czech: Český metrologický institut, ČMI, [product catalogue](https://www.cmi.cz/sites/all/files/public/download/katalog_OI%20Praha_2015_%C4%8Desky.pdf) (Czech only)), in 10 cm distance from the detector
- source: radioactive liquid solution (KI + Na₂S₂O₃ in distilled water) in a 20 ml PE vial
- I-131, type: ER X, activity: 11.83 kBq, reference date: 15.12. 2022 12:00
- data acquisition time: background: ~ 1 hour; I-131: ~10 min, ~30 min
- download: [18_spectra_ER_X_source_I-131](https://github.com/juhele/opengeodata/blob/master/amateur_spectrometry/_SURO_data/Spectra_XML/18_spectra_ER_X_source_I-131.zip)
