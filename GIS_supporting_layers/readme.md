...
The use of map layers is subject to the license terms of the respective data provider.
...
*Použití mapových vrstev se řídí licenčními podmínkami příslušného poskytovatele dat.*
